...
Begin VB.Form frmArticleUnit 
   Caption         =   "품명코드관리"
   ClientHeight    =   6765
   ClientLeft      =   4470
   ClientTop       =   1770
   ClientWidth     =   8670
   Icon            =   "frmArticleUnit.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabForm 
      ...
      TabHeight       =   679
      TabCaption(0)   =   "규격 관리 "
      TabPicture(0)   =   "frmArticleUnit.frx":000C
      Tab(0).ControlEnabled=   0   'False
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "색상 관리"
      TabPicture(1)   =   "frmArticleUnit.frx":0028
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "사종 관리"
      TabPicture(2)   =   "frmArticleUnit.frx":0044
   ...
   End
End
Attribute VB_Name = "frmArticleUnit"
...
Private Const LIMIT_WIDTH = 3040
...
Private Sub InitGrid()
    ...
    With grdData
        ...
        .TextArray(0) = ""
        .TextArray(1) = "코드": .ColWidth(1) = 550: .ColAlignment(1) = flexAlignCenterCenter
        .TextArray(2) = "규격명": .ColWidth(2) = LIMIT_WIDTH: .ColAlignment(2) = flexAlignLeftCenter
...
Private Sub tabForm_Click(PreviousTab As Integer)
    ...
    Call PlusMDI.RunForm(1110 + (10 * tabForm.Tab))
...
Private Sub FillGrid()
    ...
    Select Case tabForm.Tab
        Case 0 ' [0] 규격 관리
            oCode.CodeType = CD_STANDARD
        Case 1 ' [1] 색상 관리
            oCode.CodeType = CD_COLOR
        Case 2 ' [2] 사종 관리
            oCode.CodeType = CD_THREAD
    End Select
