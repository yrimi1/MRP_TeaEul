...
Begin VB.Form frmAccountByOrder 
   ClientHeight    =   9255
   ClientLeft      =   1665
   ClientTop       =   1470
   ClientWidth     =   15180
   Icon            =   "frmAccountByOrder.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "frmAccountByOrder"
...
Private Const REPORTFILE = "\Report\AccountByOrder.rpt"
...
Private Sub cmdSearch_Click()
    ...
    Set rs = oAccount.GetAccountByOrder(sDate, nChkCustom, sCustomID, nChkArticle, sArticleID, nChkOrder, sOrder)
...
Private Sub InitGrid()
    ...
    With grdData
        ...
        .TextMatrix(0, 2) = "Order No.":    .ColWidth(2) = 1350:            .ColAlignment(2) = flexAlignLeftCenter
        .TextMatrix(0, 3) = "관리번호":     .ColWidth(3) = 1350:            .ColAlignment(3) = flexAlignCenterCenter
