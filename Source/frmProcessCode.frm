...
Begin VB.Form frmProcessCode 
   Caption         =   "종합코드관리"
   ClientHeight    =   6765
   ClientLeft      =   405
   ClientTop       =   1200
   ClientWidth     =   8670
   Icon            =   "frmProcessCode.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabForm 
      ...
      TabHeight       =   679
      TabCaption(0)   =   "작업조 구분"
      TabPicture(0)   =   "frmProcessCode.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "염색 호기별 액비"
      TabPicture(1)   =   "frmProcessCode.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "실물 밧자기"
      TabPicture(2)   =   "frmProcessCode.frx":0044
   ...
   End
End
Attribute VB_Name = "frmProcessCode"
...
Private Sub cmdOperate_Click(Index As Integer)
    ...
    '---------------------------------------------------------------------------
        Case ID_DELETE '[3] 삭제
            If tabForm.Tab = 1 Then Exit Sub
...
Private Sub tabform_Click(PreviousTab As Integer)
    ...
    Call PlusMDI.RunForm(1510 + (10 * tabForm.Tab))
...
Private Sub FillGrid()
    ...
    Select Case tabForm.Tab
        Case 0 ' [0] 작업조
            oCode.CodeType = CD_TEAM
        Case 1 ' [1] 염색 호기별 액비
            oCode.CodeType = CD_WaterRate
        Case 2 ' [2] 실물 밧자기 번호
            oCode.CodeType = CD_BatJa
    End Select
