...
Begin VB.Form frmCommonCode 
   Caption         =   "종합코드관리"
   ClientHeight    =   6765
   ClientLeft      =   5130
   ClientTop       =   1890
   ClientWidth     =   9345
   Icon            =   "frmCommonCode.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabForm 
      ...
      TabHeight       =   679
      TabCaption(0)   =   "부서 관리 "
      TabPicture(0)   =   "frmCommonCode.frx":000C
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "직책 관리"
      TabPicture(1)   =   "frmCommonCode.frx":0028
   ...
   End
End
Attribute VB_Name = "frmCommonCode"
...
Private Sub tabForm_Click(PreviousTab As Integer)
    ...
    Call PlusMDI.RunForm(1210 + (10 * tabForm.Tab))
...
Private Sub FillGrid()
    ...
    Select Case tabForm.Tab
        Case 0 ' [0] 부서 관리
            oCode.CodeType = CD_DEPART
        Case 1 ' [1] 직책 관리
            oCode.CodeType = CD_DUTY
    End Select
