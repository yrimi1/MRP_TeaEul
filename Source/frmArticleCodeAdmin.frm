...
Begin VB.Form frmArticleCodeAdmin 
   Caption         =   "품명관리"
   ClientHeight    =   5760
   ClientLeft      =   3525
   ClientTop       =   5220
   ClientWidth     =   7605
   Icon            =   "frmArticleCodeAdmin.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5760
   ScaleWidth      =   7605
   ...
   Begin Threed.SSPanel pnlBoard 
      ...
      Begin Threed.SSPanel pnlEdit 
         ...
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
         Begin VB.OptionButton optUseClss 
            Caption         =   "비사용"
            Height          =   285
            Index           =   1
            Left            =   2010
         ...
         Begin Threed.SSCommand cmdFind 
            ...
            PictureFrames   =   1
            Enabled         =   0   'False
            Picture         =   "frmArticleCodeAdmin.frx":000C
            ButtonStyle     =   3
            Outline         =   0   'False
         End
         Begin Threed.SSCommand cmdFind 
            ...
            PictureFrames   =   1
            Enabled         =   0   'False
            Picture         =   "frmArticleCodeAdmin.frx":0326
            ButtonStyle     =   3
            Outline         =   0   'False
         End
         Begin Threed.SSPanel pnlCaption 
   ...
   End
End
Attribute VB_Name = "frmArticleCodeAdmin"
...
Private Function SaveData() As Boolean
    ...
    With NewArticle
        ...
        .UseClss = IIf(optUseClss(0).Value = True, "", "*")
    End With
...
Private Sub InitGrid()
    ...
    With grdData
        ...
        .TextArray(4) = "사종구분ID":   .ColWidth(4) = 0
        .TextArray(5) = "원단폭":       .ColWidth(5) = 0
        .TextArray(6) = "원단폭ID":     .ColWidth(6) = 0
        .TextArray(7) = "염색기":       .ColWidth(7) = 0
        .TextArray(8) = "중량":         .ColWidth(8) = 0
        .TextArray(9) = "사용구분":     .ColWidth(9) = 0
        .Redraw = True
    End With
End Sub
    ...
    With grdData
        ...
        Do Until rs.EOF
            .AddItem CStr(.Rows) & vbTab & CStr(rs!ArticleID) & vbTab & rs!Article & vbTab & _
                ...
                CheckNull(rs!DyeingID) & vbTab & CheckNull(rs!Weight) & vbTab & rs!UseClss
            
            If rs!UseClss = "*" Then
                .Cell(flexcpBackColor, .Rows - 1, 0, .Rows - 1, 0) = &HC0C0FF
            End If
...
Private Sub ShowData()
    ...
    With grdData
        ...
        If .TextMatrix(.Row, 9) = "*" Then
            optUseClss(1).Value = True
        Else
            optUseClss(0).Value = True
        End If
